...
function calcTotal() {
 ...
 /*
 Add alerts to span tags; Newly added date format.
 */
	var valid = true;
...
function Date() {
	var order_Date = new Date("02/03/2018");
	document.getElementsByID("order_Date").innerHTML = order_Date();
}

/*
Load function to web page and added date format.
*/
function init() {
